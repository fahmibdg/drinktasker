...
from drinktaskerapp import views
...
#Restaurant
    ...
    url(r'^restaurant/coffee/$', views.restaurant_coffee, name = 'restaurant-coffee'),
    url(r'^restaurant/coffee/add/$', views.restaurant_add_coffee, name = 'restaurant-add-coffee'),
    url(r'^restaurant/coffee/edit/(?P<coffee_id>\d+)/$', views.restaurant_edit_coffee, name = 'restaurant-edit-coffee'),
